...
/**
 * Initialize Stories page filtering with premium interactive transitions
 */
function initStoriesFilter() {
    ...
    const cards = document.querySelectorAll('.g3 .card');
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            // Set active class styling on buttons
            ...
            // Show/hide cards with micro-animations
            cards.forEach(card => {
            ...
            // Update counter
            if (counter) {
                counter.textContent = `Showing ${visibleCount} Impact Stories`;
            }
        });
    });
}
